...
import 'package:geocoding/geocoding.dart'; // ✅ Make sure this is imported
    ...
    try {
      ...
      try {
        ...
        if (placemarks.isNotEmpty) {
          ...
          setState(() {
            // Priority: Locality (City) -> SubLocality -> AdministrativeArea (State)
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: _isLoading 
                    ? null 
                    : (selfieImage == null ? openCamera : confirmCheckIn),
                icon: _isLoading 
                    ? Container() 
                ...
                label: _isLoading
                    ...
                    : Text(
                        selfieImage == null ? "Check In" : "Confirm Check-In",
